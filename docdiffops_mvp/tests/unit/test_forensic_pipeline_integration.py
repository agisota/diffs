...
# Stub heavy native deps not installed in the test venv so the import chain
# (pipeline → extract → fitz, bs4, etc.) resolves without errors.
# Must appear before any docdiffops.pipeline import.
_STUBS = [
